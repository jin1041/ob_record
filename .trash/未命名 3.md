...
![](https://pic3.zhimg.com/80/v2-8b442ffd03ea0f103e9acc37a1db910a_720w.webp)
...
![](https://pic4.zhimg.com/80/v2-f6380627207ff4d1e72addfafeaff0bb_720w.webp)
...
![](https://pic2.zhimg.com/80/v2-6444601b4c41d99e70569b0ea388c3bd_720w.webp)
...
![](https://pic3.zhimg.com/80/v2-4f4958704952dcf2c4b652a1cd38f32e_720w.webp)
...
![](https://pic2.zhimg.com/80/v2-9699a37b96c2b62d22b312b5e1863acd_720w.webp)
...
![](https://pic2.zhimg.com/80/v2-9caab2c9a00f6872854fb89278f13ee1_720w.webp)

Q乘以K的转置的计算

得到��� 之后，使用 Softmax 计算每一个单词对于其他单词的 attention 系数，公式中的 Softmax 是对矩阵的每一行进行 Softmax，即每一行的和都变为 1.

![](https://pic1.zhimg.com/80/v2-96a3716cf7f112f7beabafb59e84f418_720w.webp)

对矩阵的每一行进行 Softmax

得到 Softmax 矩阵之后可以和**V**相乘，得到最终的输出**Z**。

![](https://pic4.zhimg.com/80/v2-7ac99bce83713d568d04e6ecfb31463b_720w.webp)

Self-Attention 输出

上图中 Softmax 矩阵的第 1 行表示单词 1 与其他所有单词的 attention 系数，最终单词 1 的输出 �1 等于所有单词 i 的值 �� 根据 attention 系数的比例加在一起得到，如下图所示：

![](https://pic3.zhimg.com/80/v2-27822b2292cd6c38357803093bea5d0e_720w.webp)
...
![](https://pic2.zhimg.com/80/v2-b0ea8f5b639786f98330f70405e94a75_720w.webp)
...
![](https://pic1.zhimg.com/80/v2-6bdaf739fd6b827b2087b4e151c560f4_720w.webp)

多个 Self-Attention

得到 8 个输出矩阵 �1 到 �8 之后，Multi-Head Attention 将它们拼接在一起 **(Concat)**，然后传入一个**Linear**层，得到 Multi-Head Attention 最终的输出**Z**。

![](https://pic4.zhimg.com/80/v2-35d78d9aa9150ae4babd0ea6aa68d113_720w.webp)
...
![](https://pic2.zhimg.com/80/v2-0203e83066913b53ec6f5482be092aa1_720w.webp)
...
![](https://pic3.zhimg.com/80/v2-a4b35db50f882522ee52f61ddd411a5a_720w.webp)
...
![](https://pic4.zhimg.com/80/v2-4b3dde965124bd00f9893b05ebcaad0f_720w.webp)
...
![](https://pic2.zhimg.com/80/v2-47b39ca4cc3cd0be157d6803c8c8e0a1_720w.webp)
...
![](https://pic3.zhimg.com/80/v2-f5049e8711c3abe8f8938ced9e7fc3da_720w.webp)
...
![](https://pic1.zhimg.com/80/v2-4616451fe8aa59b2df2ead30fa31dc98_720w.webp)
...
![](https://pic1.zhimg.com/80/v2-b26299d383aee0dd42b163e8bda74fc8_720w.webp)

输入矩阵与 Mask 矩阵

**第二步：**接下来的操作和之前的 Self-Attention 一样，通过输入矩阵**X**计算得到**Q,K,V**矩阵。然后计算**Q**和 �� 的乘积 ��� 。

![](https://pic4.zhimg.com/80/v2-a63ff9b965595438ed0c0e0547cd3d3b_720w.webp)

Q乘以K的转置

**第三步：**在得到 ��� 之后需要进行 Softmax，计算 attention score，我们在 Softmax 之前需要使用**Mask**矩阵遮挡住每一个单词之后的信息，遮挡操作如下：

![](https://pic2.zhimg.com/80/v2-35d1c8eae955f6f4b6b3605f7ef00ee1_720w.webp)

Softmax 之前 Mask

得到 **Mask** ��� 之后在 **Mask** ���上进行 Softmax，每一行的和都为 1。但是单词 0 在单词 1, 2, 3, 4 上的 attention score 都为 0。

**第四步：**使用 **Mask** ���与矩阵 **V**相乘，得到输出 **Z**，则单词 1 的输出向量 �1 是只包含单词 1 信息的。

![](https://pic4.zhimg.com/80/v2-58f916c806a6981e296a7a699151af87_720w.webp)
...
![](https://pic2.zhimg.com/80/v2-335cfa1b345bdd5cf1e212903bb9b185_720w.webp)

Decoder Softmax 之前的 Z

Softmax 根据输出矩阵的每一行预测下一个单词：

![](https://pic2.zhimg.com/80/v2-0938aa45a288b5d6bef6487efe53bd9d_720w.webp)
